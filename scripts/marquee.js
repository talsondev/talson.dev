function initTechStackMarquee() {
  ...
  function syncScrollFromVirtual() {
    // Use transform instead of scrollLeft to avoid layout recalculation
    // This keeps the animation on the GPU
    track.style.transform = `translateX(-${virtualOffset}px)`;
  }
  ...
  // Ensure track can use transform
  ...
  marquee.addEventListener(
    ...
    (event) => {
      ...
      syncScrollFromVirtual();
      running = true;  // Resume animation after wheel input
    },
    { passive: false }
  );

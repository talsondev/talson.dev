...
new MutationObserver((mutations) => {
    for (const m of mutations) {
        for (const n of m.addedNodes) {
            ...
            if (n instanceof HTMLDialogElement && n.dataset.modal) ensureDialogCleanup(n);
...
document.addEventListener("pointerenter", (e) => {
    const trigger = e.target.closest(".peek-modal-hover-link");
...
document.addEventListener("pointermove", (e) => {
    document.querySelectorAll(".peek-shell.has-top-trigger.enable-top-hover").forEach((shell) => {
